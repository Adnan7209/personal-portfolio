...
const ProjectTabSection = ({ techUsed, description }) => {
  return (
    <div className="relative  w-full md:w-[80%] ">
      {/* <div className="absolute animate-pulse inset-0 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 filter blur-md"></div> */}<div className="bg-white opacity-60  blur-sm absolute inset-0"></div>
