  ...
  return (
    ...
    <div className="relative  mt-20  ">
      ...
      <div className="flex md:flex-row  flex-col mt-28 bg-neutral-900 rounded-3xl  relative  ">
        <div className=" mt-16 flex flex-col gap-10  h-[41vh] md:h-[75vh] ">
        ...
        <div className="h-[50vh] md:h-[85vh]  overflow-hidden mt-14 md:mt-0 mb-2 md:mb-0 ">
          <div className="flex flex-wrap justify-center animate-scroll-y-sm md:animate-scroll-y-md  lg:animate-scroll-y-lg">
