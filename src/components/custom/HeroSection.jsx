  ...
  return (
    <section>
      <div className="grid grid-cols-1 md:grid-cols-12 md:px-10 mb-[150px] relative">
        ...
        <div className="text-[#403f3f] select-none text-8xl  md:text-[120px] font-bold absolute -bottom-[160px] left-[30px] lg:-bottom-[160px] lg:left-[590px] xl:left-[750px] opacity-35">
          Adnan
        </div>
      </div>
    </section>
