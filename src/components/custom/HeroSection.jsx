    ...
    <section>
      <div className="grid grid-cols-1 md:grid-cols-12 ">
        <div className="md:col-span-7  place-self-center text-center sm:text-left mb-16 md:mb-0 ">
          <div className="text-white text-2xl md:text-5xl  mb-4  font-extrabold px-15">
            <span className="text-transparent  text-4xl md:text-6xl spa bg-clip-text bg-gradient-to-br from-purple-500 via-purple-500 to bg-pink-500">
              Hello,I'm{" "}
            </span>
            <br />
            <TypeAnimation
              ...
              wrapper="span"
              speed={50}
              style={{ fontSize: "2em", display: "inline-block", lineHeight: '1' }}
              repeat={Infinity}
            />
          </div>
          <p className="text-[#ADB7BE] text-lg lg:text-xl mt-10 px-5 italic mb-3">
        ...
        <div className="md:col-span-5 place-self-center relative   ">
          <div className="rounded-full bg-gradient-to-br from-purple-500 via-purple-500 to bg-pink-500  w-[250px] md:w-[350px] md:h-[350px] h-[250px]   filter blur-xl">
